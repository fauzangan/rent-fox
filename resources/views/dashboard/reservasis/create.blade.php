    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('dashboard.reservasis.store') }}" method="POST">
                ...
                @include('dashboard.reservasis.partials.create-reservasi-item-form')
...
<script src="{{ asset('assets/js/page/reservasi-create.js') }}"></script>
<script src="{{ asset('assets/js/page/reservasi-create-items.js') }}"></script>
{{-- <script>
