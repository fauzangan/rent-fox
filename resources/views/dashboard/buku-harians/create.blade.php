        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col pr-0">
                        <div class="form-group">
                            <label for="">Total Harga x Disc</label>
        ...
        function getOrderData(orderId){
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#modalTotalHarga').val('Rp '+formatRupiah(parseInt(response.total_harga)));
                    $('#modalDiscount').val(response.discount+'%');
                    $('#modalTotalHargaDisc').val('Rp '+formatRupiah(parseInt(response.total_harga_disc)));
