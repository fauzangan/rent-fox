                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status_transport_id') is-invalid @enderror" name="status_transport_id" id="status_transport_id">
                                ...
                                <option value="{{ $status_transport->status_transport_id }}" {{ old('status_transport_id') == $status_transport->status_transport_id ? 'selected' : '' }}>{{ $status_transport->nama_status }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control @error('status_order_id') is-invalid @enderror" name="status_order_id" id="status_order_id">
                                ...
                                <option value="{{ $status_order->status_order_id }}" {{ old('status_order_id') == $status_order->status_order_id ? 'selected' : '' }}>{{ $status_order->nama_status }}</option>
                                @endforeach
                            </select>
