...
<div class="section-header">
    <h1>Tambah Kategori Items</h1>
    <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="{{ route('dashboard.main-dashboard.index') }}">Dashboard</a></div>
        <div class="breadcrumb-item active"><a href="{{ route('dashboard.category-items.index') }}">Category Items</a>
        </div>
...
<div class="section-body">
    <div class="card px-3 mx-xl-5">
        ...
        <form action="{{ route('dashboard.category-items.create') }}" method="POST">
            @csrf
            <div class="card-body">
                <div class="form-group">
                    <label>Nama Kategori</label>
                    <input type="text" class="form-control @error('nama_category') is-invalid @enderror" name="nama_category" value="{{ old('nama_category') }}">
                    @error('nama_category')
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control @error('prefiks') is-invalid @enderror" name="prefiks" value="{{ old('prefiks') }}">
                    @error('prefiks')
                    <div class="invalid-feedback">
                        {{ $message }}
                    </div>
